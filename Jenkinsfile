...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/avr128da48-generating-pwm-signals-using-tcd-hf.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/avr128da48-generating-pwm-signals-using-tcd-hf.git'
